...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {   
      ...
      if(!user || user == null || user.id == null || !user.id) return message.reply("<a:no:865963806483808256> Could Not Find The USER")
      try{
        ...
        embeduserinfo.setAuthor("Information about:   " + user.username + "#" + user.discriminator, user.displayAvatarURL({ dynamic: true }), "https://discord.gg/pZAbVuH")
