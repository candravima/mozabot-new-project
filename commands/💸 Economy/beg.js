  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    if (!client.settings.get(message.guild.id, "ECONOMY")) {
      return message.channel.send(new MessageEmbed()
        ...
        .setTitle(`<a:no:865963806483808256> THIS COMMAND IS CURRENTLY DISABLED`)
    ...
    try {
      ...
      if (user.bot) return message.reply("<a:no:865963806483808256> **A Discord Bot Can Not Have Economy!**")
      ...
      if (data.beg !== 0 && timeout - (Date.now() - data.beg) > 0) {
        ...
        return message.reply({
          embed: new MessageEmbed()
            ...
            .setTitle(`<a:no:865963806483808256> You've already collected your beg reward!`)
