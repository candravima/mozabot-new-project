      ...
      if (temptype == "add") {
        ...
        for (let i = 0; i < cuc.length; i++) {
          try {
            ...
            embed.addField(`<:ArrowRR:867324401015980063> \`${cuc[i].name}\` | ${cuc[i].embed ? "✅ Embed" : "❌ Embed"}`, ">>> <:ArrowRR:867324401015980063> **__OUTPUT__**\n" + string + "\n<:ArrowRR:867324401015980063> **__ALIASES__**\n" + aliases + "\n<:ArrowRR:867324401015980063> **__CHANNELS__**\n" + channels)
          } catch (e) {
            console.log(e)
          }
        }
